...
if (!empty($_POST)) {
    ...
    $resultMail = mail( "viacheslav.suprun@yandex.ru", "Сообщение с сайта", $message, $headers );
    
    if ( $resultMail ) {
        echo "Форма отправлена успешно!";
    } else {
        echo "Что то пошло не так. Форма не отправлена.";
    }
}
...
<form action="index.php" method="post">
    ...
    <input type="submit" value="Отправить форму!"><br>
</form>
